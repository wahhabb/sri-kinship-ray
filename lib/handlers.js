...
//exports.resGender = (req, res) => res.render("gender");
//exports.resEcology = (req, res) => res.render("ecology");
//Commented out the above two lines as they should not be needed - but left them just in case
